          ...
          <div class="card shadow">
            ...
            <table class="table table-striped table-bordered" id="example"  cellspacing="0" width="100%">
                ...
                <tr class="data-row">
                    ...
                    <button type="button" class="btn btn-primary" id="edit-item" data-item-id="{{$r->id_jurusan}} ">Edit</button>
                    <!-- <a href="/jurusan/hapus/{{$r->id_jurusan}}" onclick="return confirm('Anda Yakin ?')" class="btn btn-danger">Hapus</a> -->
                    </td>
                </tr>
                @endforeach
                </tbody>
